...
\section{Blockchain}
Blockchain in bitcoin is data structure that holds every transaction that had taken place since beginning. It consists of blocks of transactions, with each block holding in itself hash of previous block. One notable property of this data structure is that modification of single block would require modification of every block that followed. Because of restrictions imposed on block creation, creating blocks is computationally complex operation, thus modification of block that had been followed by 6 other blocks is considered impossible.

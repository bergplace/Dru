...
\item
Process constantly updating database with new blocks that are gathered by bitcoin node
\item
Web application ready to be used to create complex functionalities
\end{itemize}

TUTAJ WSTAWIĆ JAKIŚ PIĘKNY DIAGRAM!!!
\\
TUTAJ WSTAWIĆ JAKIŚ PIĘKNY DIAGRAM!!!
\\
TUTAJ WSTAWIĆ JAKIŚ PIĘKNY DIAGRAM!!!

...
At the beginning let's simplify the choice between RDBMS and NoSQL databases. Out of many NoSQL possibilities I have chosen MongoDB (web page: www.mongodb.com) database based on some research of different NoSQL systems strengths and weaknesses.
